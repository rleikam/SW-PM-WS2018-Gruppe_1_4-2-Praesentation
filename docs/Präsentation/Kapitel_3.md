...
--
* Beschreibung eines zeitlichen Verlaufs für einen Sachverhalt
...
** weitere Phasen ** - Wartung, Weiterentwicklung, Außerbetriebnahme
---
# Projektlebenszyklus
...
**Aspekte der Analyse** - Machbarkeit, Risiken, Wirtschaftlichkeit
--
...
**Beispiele** - Meilensteinpläne, Arbeits- und Zeitpläne, Ressourcenpläne, weitere Pläne
--
...
**Pflichtenheft** - Resultate aus der Verfeinerung, welche umgesetzt werden
--
* Systementwurf
...
**Artefakte** -  Modelle, Code, Ressourcendateien und Testfälle  
**Aufwand** - hoher Personalaufwand  
**Implementierungsbeginn** - nicht zu früh beginnen (Kosten und Kommunikationsaufwand, gute Koordination und Maßstäbe nötig
gute Präzisierung der Implementierungsaufgaben für das Erreichen der Ziele
--
